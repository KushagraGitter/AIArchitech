...
export const  initialTemplates: { name: string; nodes: Node<NodeData>[]; edges: Edge[] }[] = [
    ...
    },
    {
      ...
      nodes: [
        ...
        { id: 'tiny_cache_1', type: 'custom', position: { x: 450, y: 300 }, data: { label: 'Hot URL Cache', iconName: 'Zap', properties: {...(designComponents.find(c => c.name === "Cache")?.initialProperties || {}), type: "Redis", custom: {use: "Frequently accessed URLs", pattern: "Cache-Aside"}} } },
      ],
      edges: [
